...
function Flavia() {
    ...
    async function graficRevenueExpense() {
        ...
        var config = {
            method: 'GET',
            url: api.url_base_api + '/grafics/launchRevenueLaunchExpenseAnoMes/' + mesValue + '/' + anoValue + '/' + 'Flavia',
        };
        try {
    ...
    async function graficRevenue() {
        ...
        var config = {
            method: 'GET',
            url: api.url_base_api + '/grafics/launchRevenueAnoMes/' + mesValue + '/' + anoValue + '/' + 'Flavia',
        };
        try {
            const response = await axios(config);
            if (response.status == 200) {
    ...
    async function graficExpense() {
        ...
        var config = {
            method: 'GET',
            url: api.url_base_api + '/grafics/launchExpenseAnoMes/' + mesValue + '/' + anoValue + '/' + 'Flavia',
        };
        try {
            const response = await axios(config);
            if (response.status == 200) {
