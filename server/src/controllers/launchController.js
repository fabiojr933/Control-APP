...
class launchController {
    ...
    async allLaunchExpenseUser(req, res) {
        try {
            ...
            let dados = await knex.raw(`select launchExpense.id, launchExpense.fixed, launchExpense.fixedRodam, expense.description, launchExpense.value from launchExpense 
    ...
    async allLaunchRevenueUser(req, res) {
        try {
            ...
            let year = req.params.year;
            let user = req.params.user;
            let dados = await knex.raw(`select launchRevenue.id, launchRevenue.fixed, launchRevenue.fixedRodam, revenue.description, launchRevenue.value from launchRevenue 
